    ...
    >
      <div>
        <span class="block font-medium text-gray-700 text-theme-sm dark:text-gray-400">
          {{ auth_store.user_details.firstname }} {{ auth_store.user_details.lastname }} 
        </span>
      ...
      >
        <Icon class="text-2xl" icon="heroicons:arrow-left-start-on-rectangle-20-solid"/>
        Sign out
      </button>
    </div>
    <!-- Dropdown End -->
...
const menuItems = [
  { href: '/profile', icon: 'heroicons:user-circle', text: 'Profile' },
  { href: '/login-history', icon: 'heroicons-outline:list-bullet', text: 'Login History' },
