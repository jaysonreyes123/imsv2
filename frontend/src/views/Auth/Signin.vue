        ...
        <div>
          ...
          <div>
            <Alert
                ...
                :showLink="false"
              />
            <form @submit.prevent="auth_store.login()">
              <div class="space-y-5">
                <!-- Email -->
                <div>
                  <label
                ...
                <div>
                  ...
                  <div class="relative">
                    <input
                      v-model="auth_store.form.password"
                ...
                <!-- Button -->
                <div>
                  <Button text="Sign in" type="submit" btnClass="btn btn-primary block w-full text-center" :isLoading="auth_store.loading" />
                </div>
              </div>
            </form>
          </div>
