<template>
            ...
            <div>
              ...
              <form @submit.prevent="auth_store.resetPassword()">
                <div class="space-y-5">
                  ...
                  <div class="relative">
                    <input
                      v-model="auth_store.resetform.password"
                ...
                <div>
                  <label
                    ...
                    class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400"
                  >
                   Re-type Password<span class="text-error-500">*</span>
                  </label>
                  <div class="relative">
                    <input
                      v-model="auth_store.resetform.repassword"
                  ...
                  <!-- Button -->
                  <div>
                    <Button text="Reset password" type="submit" btnClass="btn btn-primary block w-full text-center" :isLoading="auth_store.loading" />
                  </div>
  ...
  auth_store.resetform.repassword = '';
